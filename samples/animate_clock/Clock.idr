...
clock_Hand : Integer    -- Dividing the clock into 60 parts, this integer represents which part the hand points to.
...
clock : Integer -> Picture
clock s = Pictures ([Circle     center black False 120
